...
'use strict';
const flavors={
lime:{index:"01",name:"Ion Lime",split:"Ion<br>Lime",image:"nox-ion-lime.webp",alt:"Black NØX Drive Ion Lime pre-workout tub with vivid lime signal graphics",accent:"#c9ff36",rgb:"201,255,54",signal:"Citrus frequency",hero:"Lime and yuzu. A sharp citrus taste with a dry finish.",description:"Acid lime, bright yuzu, and a restrained mineral finish. Clean, dry, and intentionally electric.",notes:["Acid / 4 of 5","Sweet / 2 of 5","Dry finish"]},
berry:{index:"02",name:"Riot Berry",split:"Riot<br>Berry",image:"nox-riot-berry.webp",alt:"Black NØX Drive Riot Berry pre-workout tub with vivid magenta signal graphics",accent:"#ff3f87",rgb:"255,63,135",signal:"Redline frequency",hero:"Red berries and hibiscus. Bold, tart and never subtle.",description:"Tart raspberry, blackcurrant depth, and hibiscus bite. Dark fruit tuned above the sugar noise.",notes:["Tart / 4 of 5","Sweet / 3 of 5","Berry finish"]},
polar:{index:"03",name:"Polar Shock",split:"Polar<br>Shock",image:"nox-polar-shock.webp",alt:"Black NØX Drive Polar Shock pre-workout tub with vivid ice-blue signal graphics",accent:"#55ddff",rgb:"85,221,255",signal:"Cold frequency",hero:"Blue raspberry and citrus. A crisp, cooling finish.",description:"Blue raspberry, lucid citrus, and a calibrated cooling finish. High contrast without heavy sweetness.",notes:["Cold / 5 of 5","Sweet / 3 of 5","Clean finish"]}};
const $=s=>document.querySelector(s), $$=s=>[...document.querySelectorAll(s)];
const cart=createDemoCart({overlay:'#backdrop',trigger:'.cart-trigger',list:'#cart-items',total:'#total',badge:'.count',currency:'USD',noun:'bag',openClass:'active',overlayClass:'active',bodyClass:'cart-open'});
let active='lime';
function select(key) {
